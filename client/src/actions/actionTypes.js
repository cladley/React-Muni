...
export const GET_STOP_PREDICTIONS = 'GET_STOP_PREDICTIONS';
export const GET_STOP_PREDICTIONS_SUCCESS = 'GET_STOP_PREDICTIONS_SUCCESS';
export const GET_STOP_PREDICTIONS_FAILURE = 'GET_STOP_PREDICTIONS_FAILURE';
